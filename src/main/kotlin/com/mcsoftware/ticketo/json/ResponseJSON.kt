...
class ResponseJSON<T>(
    ...
    fun useResponse(anyData: T): ResponseJSON<T> {
        return when (this.statusCode) {
            ...
            // errors
            HttpStatus.SERVICE_UNAVAILABLE.value() -> ResponseJSON(
            ...
            HttpStatus.NOT_FOUND.value() -> ResponseJSON(
            ...
            HttpStatus.UNAUTHORIZED.value() -> ResponseJSON(
            ...
            HttpStatus.FORBIDDEN.value() -> ResponseJSON(
            ...
            HttpStatus.INTERNAL_SERVER_ERROR.value() -> ResponseJSON(
            ...
            HttpStatus.METHOD_NOT_ALLOWED.value() -> ResponseJSON(
            ...
            HttpStatus.BAD_GATEWAY.value() -> ResponseJSON(
            ...
            HttpStatus.BAD_REQUEST.value() -> ResponseJSON(
            ...
            HttpStatus.NOT_IMPLEMENTED.value() -> ResponseJSON(
